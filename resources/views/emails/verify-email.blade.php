...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="message">
                Terima kasih telah mendaftar di <strong>SiDarku</strong>! Untuk melanjutkan, silakan verifikasi alamat email Anda dengan mengklik tombol di bawah ini.
            </div>
            ...
            <div class="info-box">
                ...
                <p class="info-box-text">
                    • Link verifikasi akan kedaluwarsa dalam 60 menit<br>
                    • Jika tombol tidak berfungsi, salin dan tempel link di bawah ini ke browser Anda<br>
                    • Jika Anda tidak mendaftar di SiDarku, abaikan email ini
                </p>
            </div>
