    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-50 hidden lg:block">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.ttd-reminder-logs') }}" class="flex items-center space-x-2 px-2.5 py-1.5 rounded-lg transition-colors {{ request()->routeIs('admin.ttd-reminder-logs') ? 'bg-pink-50 text-sidarku-primary' : 'text-gray-700 hover:bg-gray-50' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span class="text-xs font-medium">TTD Reminder Logs</span>
                </a>
            </nav>
